...
export default {
  ...
  methods: {
    ...
    componentDetail() {
      axios
        .get(`http://192.168.88.11:5000/app/current_component/${this.id}/`)
        .then((response) => {
    ...
    testing() {
      axios
        .get(`http://192.168.88.11:5000/app/testing/${this.component.id}/`)
        .then((response) => {
        ...
        setInterval(() => { axios
            .get(`http://192.168.88.11:5000/app/getstatus/${this.component.id}/`)
            .then((response) => {
              console.log(response.data);
